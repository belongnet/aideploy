"""
OpenClaw (beta) Agent — Main entry point.
...
Note: This legacy Python stack is preserved as reference code. The live
user-facing runtime is OpenClaw; launcher product, container, and on-disk names
also retain the `openclaw-*` prefixes. See CLAUDE.md.
"""
